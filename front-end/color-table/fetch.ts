export type Color = {
   ...
   */
  export function fetchByHex(hexCode: string): Promise<Color> {
   ...
   */
  export function fetchByName(colorName: string): Promise<Color> {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
